...
IF EXIST "test\Rhetos.LightDMS.TestApp\AfterDeploy" RD /S/Q "test\Rhetos.LightDMS.TestApp\AfterDeploy"
IF EXIST "test\Rhetos.LightDMS.TestApp\DslScripts\LightDMS" RD /S/Q "test\Rhetos.LightDMS.TestApp\DslScripts\LightDMS"
IF EXIST "test\Rhetos.LightDMS.TestApp\DataMigration" RD /S/Q "test\Rhetos.LightDMS.TestApp\DataMigration"
